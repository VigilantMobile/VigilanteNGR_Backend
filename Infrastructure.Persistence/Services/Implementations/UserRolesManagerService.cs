...
namespace Infrastructure.Persistence.Services
{
    public class UserRolesManagerService : IUserRolesManagerService
    {
        ...
        public async Task<Response<UserRolesViewModel>> AddUserToRoles(AddUserToRoleRequest addUserToRoleRequest)
        {
            ...
            if (user == null)
            {
                return new Response<UserRolesViewModel>(userRoles, responsestatus: APIResponseStatus.fail.ToString(), message: $"User does not exist");
            }
            ...
            if (!result.Succeeded)
            {
                return new Response<UserRolesViewModel>(userRoles, responsestatus: APIResponseStatus.fail.ToString(), message: $"An error occurred while attempting to remove existing roles.");
            }
            ...
            return new Response<UserRolesViewModel>(userRoles, responsestatus: APIResponseStatus.success.ToString(), message: $"User {user.Email} was successfully added to specified roles.");
        ...
        public async Task<Response<GetAllStaffRolesViewModel>> GetAllStaffRoles()
        {
            ...
            var allStaffUserIds = await _context.UserRoles.Where(r => r.RoleId != customerRole.Id && r.RoleId != superAdminRole.Id).ToListAsync();
            ...
            return new Response<GetAllStaffRolesViewModel>(staffAndRoles, responsestatus: APIResponseStatus.success.ToString(), message: $"List of all staff and associated roles successfully retrieved.");
        ...
        public async Task<Response<UserRolesViewModel>> GetUserWithRoles(string userId)
        {
            ...
            if (staffUser == null)
            {
                return new Response<UserRolesViewModel>(StaffUserRoles, responsestatus: APIResponseStatus.fail.ToString(), message: $"User does not exist");
            }
            ...
            return new Response<UserRolesViewModel>(StaffUserRoles, responsestatus: APIResponseStatus.success.ToString(), message: $"An error occurred while attempting to remove existing roles.");
        ...
        public async Task<Response<UsersAndClaimsResponse>> GetUserClaims(string userId)
        {
            ...
            {
                IdentityRole rl = await _context.Roles.Where(r => r.Name == role).FirstOrDefaultAsync();
        ...
        public async Task<Response<UsersAndClaimsResponse>> ConfigureUserClaims(ManageUserClaimsRequest manageUserClaimsRequest)
        {
            ...
            {
                return new Response<UsersAndClaimsResponse>(usersAndClaimsViewModel, responsestatus: APIResponseStatus.fail.ToString(), message: $"An invalid claim pair was detected.");
            }
