    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
           ...
           .WithMany(g => g.AdminAuthorizedCurfews).HasForeignKey(s => s.AdminAuthorizerId).OnDelete(DeleteBehavior.Restrict).OnDelete(DeleteBehavior.Restrict);
            ...
            // Category Type to Categories relationship
            builder.Entity<SecurityTipCategoryType>()
                .HasMany(t => t.Categories)
                .WithOne(c => c.CategoryType)
                .HasForeignKey(c => c.CategoryTypeId)
                .OnDelete(DeleteBehavior.Restrict); // Categories should remain even if type is deleted
